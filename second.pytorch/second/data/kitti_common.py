...
def get_velodyne_path(idx, prefix, velodyne_dir_name, training=True, relative_path=True, exist_check=True):
    # return get_kitti_info_path(idx, prefix, 'velodyne', '.bin', training,
    #                            relative_path, exist_check)
    return get_kitti_info_path(idx, prefix, velodyne_dir_name, '.bin', training,
                               relative_path, exist_check)
...
def get_kitti_image_info(path,
    ...
    def map_func(idx):
        info = {}
        pc_info = {'num_features': num_point_features} # add
        calib_info = {}
        ...
        if velodyne:
            pc_info['velodyne_path'] = get_velodyne_path(
                idx, path, velodyne_dir_name, training, relative_path)
